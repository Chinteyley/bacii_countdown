...
import { JomnouyBanner } from "@/components/jomnouy-banner";
...
export default function Page() {
  ...
  return (
    <div className="flex h-svh min-h-[640px] flex-col">
      <JomnouyBanner />
      <main className="relative grid min-h-0 flex-1 grid-rows-[auto_1fr_auto] gap-6 px-6 pt-6 pb-5 sm:px-10 sm:pt-8 sm:pb-6 md:px-16 md:pt-10 md:pb-8">
